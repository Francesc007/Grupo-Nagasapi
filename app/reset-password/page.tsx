...
export default function ResetPasswordPage() {
  ...
  const handleReset = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Cerrar sesión para que al ir al login no lo mande al home automáticamente
    ...
    <main className="min-h-screen bg-naga-cotton flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          <Link href="/" className="flex justify-center mb-0 relative w-48 h-20 mx-auto transition-transform hover:scale-105 block">
            <Image src="/Logo 1.png" alt="Logo" fill className="object-contain" priority />
          </Link>
          <h2 className="text-2xl font-black text-black uppercase tracking-tight italic -mt-2">
            Nueva Contraseña
          </h2>
