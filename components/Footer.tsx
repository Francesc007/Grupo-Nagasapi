      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        ...
        <div className="space-y-4">
          <Link href="/" className="flex items-center gap-2 group">
            <div className="relative w-12 h-12 overflow-hidden rounded-lg transition-transform group-hover:scale-110 shadow-md">
          ...
          <div className="flex gap-4">
            <Link href="https://instagram.com/gruponagasapi" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 hover:bg-naga-green hover:text-white transition-all">
              <Instagram size={20} />
            </Link>
            <Link href="#" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 hover:bg-naga-green hover:text-white transition-all">
              <Facebook size={20} />
            </Link>
            <Link href="#" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 hover:bg-naga-green hover:text-white transition-all">
              <Twitter size={20} />
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li><Link href="/" className="text-gray-500 hover:text-naga-green text-sm font-bold transition-colors">Inicio</Link></li>
            <li><Link href="/#productos" className="text-gray-500 hover:text-naga-green text-sm font-bold transition-colors">Catálogo</Link></li>
            <li><Link href="/#custom" className="text-gray-500 hover:text-naga-green text-sm font-bold transition-colors">Sube tu diseño</Link></li>
            <li><Link href="/admin" className="text-gray-500 hover:text-naga-green text-sm font-bold transition-colors">Admin Dashboard</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="text-naga-green font-black text-sm">
