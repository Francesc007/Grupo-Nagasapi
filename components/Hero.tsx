...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center pt-20 lg:pt-32 overflow-hidden bg-naga-cotton">
      ...
      <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-naga-green/5 blur-[120px] rounded-full -translate-y-1/2 translate-x-1/3" />
      ...
      <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <Link
              href="/#productos"
              className="bg-naga-green hover:bg-black text-white font-black px-8 py-5 rounded-xl flex items-center justify-center gap-2 transition-all group text-lg uppercase shadow-xl shadow-naga-green/20"
            >
              Explora Catálogo
        ...
        >
          ...
          <div className="relative w-full h-full rounded-[2.5rem] overflow-hidden border border-black/5 shadow-2xl group bg-white p-4">
            <Image
          ...
          <motion.div
            ...
            className="absolute -top-12 -right-12 w-56 h-56 bg-white border border-gray-100 rounded-[2rem] p-4 shadow-2xl hidden xl:block overflow-hidden"
          >
